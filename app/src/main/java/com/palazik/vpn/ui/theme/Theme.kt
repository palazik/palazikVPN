...
private fun oceanScheme(dark: Boolean) = if (dark)
    darkColorScheme(
...
private fun forestScheme(dark: Boolean) = if (dark)
    darkColorScheme(
...
private fun sunsetScheme(dark: Boolean) = if (dark)
    darkColorScheme(
...
// Missing import alias to avoid collision with Material Color
