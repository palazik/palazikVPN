 ...
 * JSON blob stored in the "palazik_profiles" prefs. Direct port of the Android
 * codec, plus the Linux-only tunMode/systemProxy fields.
 */
object AppSettingsCodec {
        ...
        return runCatching {
            ...
            AppSettings(
                ...
                subscriptionUpdateIntervalHours = o.optLong("subscriptionUpdateIntervalHours", d.subscriptionUpdateIntervalHours)
                    .coerceAtLeast(2L),
                tunMode = o.optBoolean("tunMode", d.tunMode),
                systemProxy = o.optBoolean("systemProxy", d.systemProxy),
    ...
    fun toJson(s: AppSettings): String = JSONObject().apply {
        ...
        put("tunMode", s.tunMode)
        put("systemProxy", s.systemProxy)
